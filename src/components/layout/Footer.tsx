        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="mt-4 text-sm text-gray-600">
              The premier platform for virtual events, connecting audiences worldwide through engaging digital experiences.
            </p>
          ...
          <div className="col-span-1">
            ...
            <ul className="mt-4 space-y-2">
              <li>
                <Link to="/events" className="text-base text-gray-600 hover:text-primary">
                  All Events
                </Link>
              </li>
              <li>
          ...
          <div className="col-span-1">
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-600">info@eventhub.com</span>
              </li>
            </ul>
          </div>
        </div>
